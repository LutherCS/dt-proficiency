...
```
    ...
    /home/yasiro01/Projects/dt-proficiency
...
**DANGER**: use `rm -rf` with great caution as it recursively and silently removes the specified directory.
...
```
     ...
     14:51:22 up 9 days,  3:56,  1 user,  load average: 0.83, 0.92, 0.86
